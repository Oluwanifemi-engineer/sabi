...
You receive the original explanation and the list of questions they answered wrong. Return STRICT JSON:
...
- bullets: 3-4 ultra-simple bullets covering what the letter asks and what happens next.
- aboutWrong: for EACH failed question, one gentle sentence clearing up the confusion, in order.
- Return ONLY valid JSON. No markdown fences.`;
